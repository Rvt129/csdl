...
public class DTNode {
    ...
    public HashMap<Object, DTNode> getChildren() {
        return children;
    }

    // children-related methods
    public DTNode getChild(Object value) {
        return children.get(value);
    }

    public void addChild(Object attribute_value, DTNode child) {
        children.put(attribute_value, child);
    }
